...
try:
    ...
    ALLOWED_HOSTS = env.list("DJANGO_ALLOWED_HOSTS", default=["ginienode.com", "www.ginienode.com"])
...
DEFAULT_FROM_EMAIL = env(
    "DJANGO_DEFAULT_FROM_EMAIL", default="ginienode <noreply@ginienode.com>"
)
...
ANYMAIL = {}
EMAIL_HOST = env("EMAIL_HOST", default="premium202-2.web-hosting.com")
