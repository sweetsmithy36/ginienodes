# Generated by Django 3.2.10 on 2021-12-15 15:57
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterModelOptions(
            name='user',
            options={'managed': True, 'ordering': ['first_name', 'middle_name', 'last_name'], 'verbose_name': 'User Account', 'verbose_name_plural': 'User Accounts'},
        ),
        ...
        migrations.AddField(
            model_name='user',
            name='user_type',
            field=models.PositiveSmallIntegerField(choices=[(1, 'Investors'), (2, 'Brokers')], default=3, verbose_name='User Account Type'),
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', model_utils.fields.AutoCreatedField(default=django.utils.timezone.now, editable=False, verbose_name='created')),
                ('modified', model_utils.fields.AutoLastModifiedField(default=django.utils.timezone.now, editable=False, verbose_name='modified')),
                ('investor_id', models.CharField(blank=True, max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('account_number', models.CharField(max_length=11, unique=True, validators=[django.core.validators.RegexValidator(code='Invalid_input, Only Integers', message='Must Contain Numbers Only', regex='^[0-9]*$')])),
                ('swift_code', models.CharField(max_length=11, unique=True, validators=[django.core.validators.RegexValidator(code='Invalid_input, Only Integers', message='Must Contain Numbers Only', regex='^[0-9]*$')])),
